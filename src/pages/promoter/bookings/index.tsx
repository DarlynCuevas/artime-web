...
import { AlertCircle, ArrowRight, Calendar, Clock, Filter, LayoutList, MapPin, Search, Ticket } from 'lucide-react';
    ...
    <main className="p-6 md:p-10 max-w-7xl mx-auto space-y-10">
      <header className="border-b border-slate-100 pb-8 mb-4">
        <div className="flex flex-col gap-1">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-slate-900">Contrataciones del promotor</h1>
                  ...
                  <div key={booking.id} className="grid grid-cols-1 md:grid-cols-12 gap-6 px-6 py-6 hover:bg-slate-50/50 transition-all group items-center">
                    <div className="md:col-span-4 space-y-1">
                      <p className="font-bold text-slate-900 leading-tight">
                        {booking.artistName || booking.artistId || 'Artista sin nombre'}
                      </p>
                      {booking.eventName && (
                        <p className="text-[12px] font-semibold text-slate-400 uppercase tracking-tight">Evento: {booking.eventName}</p>
                      )}
                    ...
                    <div className="md:col-span-3 flex flex-col gap-2">
                      ...
                      <div className="flex items-baseline gap-1">
                        <span className="text-xs font-bold text-slate-400 uppercase tracking-tighter">Fee:</span>
