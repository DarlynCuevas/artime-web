...
const USERS = {
  v: {
    ...
    name: 'Venue User',
    role: 'VENUE',
    token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2NGUxY2Q0Ny01MWViLTRlM2QtYWQ5Mi1mMTNmZGJlOTk3MWMiLCJyb2xlIjoiVkVOVUUiLCJpYXQiOjE3Njg2NDcyMTIsImV4cCI6MTc2ODczMzYxMn0.jSNkFpl1UHDjX5xF2mGAXboBMMzkEXfRxAI6zeisS04',
  },
  a: {
    id: '11111111-1111-1111-1111-111111111111',
    name: 'Artist User',
    role: 'ARTIST',
    token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMTExMTExMS0xMTExLTExMTEtMTExMS0xMTExMTExMTExMTEiLCJyb2xlIjoiQVJUSVNUIiwiaWF0IjoxNzY4Njc5Njg1LCJleHAiOjE3Njg3NjYwODV9.MJ7Da8oHthYRrrkMvNxLBZso3OrjfbrCztMNayxvPi0',
  },
  m: {
